...
//-------------------------------------------------------------------------------------
    public Debug(String _filename, int _level, boolean _dumpToFileOnly, Debug _debug, String _prefixText, int _prefixColor){
		this(_filename, _level, _dumpToFileOnly, _debug, _prefixText, _prefixColor, null);    
	}

//-------------------------------------------------------------------------------------
    public Debug(String _filename, int _level, boolean _dumpToFileOnly, Debug _debug, String _prefixText, int _prefixColor, String _directory){
    	if(_debug != null){
        	fw = _debug.fw;
    	}
